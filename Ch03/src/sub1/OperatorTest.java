...
public class OperatorTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("no1의 값 : "+no1);
		System.out.println("no2의 값 : "+no2);
		System.out.println("no3의 값 : "+no3);
		System.out.println("no4의 값 : "+no4);
		...
		//논리연산자
		boolean r1 = (var1 > 0) && (var2 > 1); //둘다 참이어야 참
		boolean r2 = (var1 > 0) && (var2 > 2); 
		boolean r3 = (var1 > 0) || (var2 > 2); //둘중에 하나만 참이어야만 참
		boolean r4 = (var1 > 1) || (var2 > 2); 
		boolean r5 = !(var1 > var2); //크지않다
